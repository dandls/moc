...
if (USE_SAVED) {
  ...
  parallelMap::parallelStartMulticore(cpus = 5L)
  set.seed(1000)
...
# T-test
t.test(x = dens.orig, y = dens.cond, paired = TRUE, alternative = "less")
